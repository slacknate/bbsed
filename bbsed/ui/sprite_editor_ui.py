...
class Ui_Editor(object):
    def setupUi(self, Editor):
        ...
        self.horizontalLayout_3.addWidget(self.character_group)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem)
        self.extra_group = QtWidgets.QGroupBox(Editor)
        self.extra_group.setObjectName("extra_group")
        self.horizontalLayout_3.addWidget(self.extra_group)
    ...
    def retranslateUi(self, Editor):
        ...
        self.extra_group.setTitle(_translate("Editor", "Extra Controls"))
